...
class CLIParser():
  ...
  def __init__(self, command, top_level_parser):
    ...
    help_text_for_command = self._get_help_text_for_command()
  ...
  def _get_help_text_for_command(self):
    """
    Get help text for each command from cli model.
    ...
    -------
      None
    """
    if self.command in self.cli_model and "help" in self.cli_model[self.command]:
      return self.cli_model[self.command]["help"]
  ...
  def create_parser(self):
    ...
    """
    if self.command in self.cli_model:
