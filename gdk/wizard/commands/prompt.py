...
class Wizard:
    ...
    def prompt_required_fields(self):
        ...
        if self.change_value(parser, field="author", value=component_author):
            while True:
                args = parser.parse_args(
                    ["--author", input("Enter the author of the component: ")]
                )
        ...
        if self.change_value(parser, field="version", value=component_version):
            while True:
                args = parser.parse_args(
                    ["--version", input("Enter the version of the component: ")]
                )
        ...
        if self.change_value(
            parser, field="build_system", value=component_build_system
        ):
            while True:
                args = parser.parse_args(
                    [
                        "--build_system",
                        input("Enter the build system of the component: "),
                    ]
                )
        ...
        if self.change_value(parser, field="bucket", value=component_bucket):
            while True:
                args = parser.parse_args(
                    ["--bucket", input("Enter the S3 bucket of the component: ")]
                )
        ...
        if self.change_value(parser, field="region", value=component_region):
            while True:
                args = parser.parse_args(
                    ["--region", input("Enter the region of the component: ")]
                )
        ...
        if self.change_value(parser, field="gdk_version", value=component_gdk_version):
            while True:
                args = parser.parse_args(
                    ["--gdk_version", input("Enter the gdk-version of the component: ")]
                )
        ...
        while True:
            args = parser.parse_args(
                [
                    "--change_value",
                    input(
                        f"Do you want to change the field {field} with value {value} ?(y/n)"
                    ),
                ]
            )
