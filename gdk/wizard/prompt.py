...
class Wizard:
    ...
    def prompt_required_fields(self):
        ...
        parser.add_argument('--change-value', help='Change the value of a component field')
        ...
        if self.change_value(parser, field='region', value=component_region):
            while True:
                args = parser.parse_args(['--bucket', input('Enter the region of the component: ')])
