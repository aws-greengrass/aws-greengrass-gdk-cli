...
def test_gdk_config_component(mocker):
    mock_config_component = mocker.patch("gdk.commands.config.config.component", return_value=None)
    methods._gdk_config_component({})
