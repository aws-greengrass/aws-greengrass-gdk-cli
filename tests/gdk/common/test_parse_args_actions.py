...
def test_check_command_args_with_conflicting_args(mocker):
    ...
    mock_list_of_command_args = mocker.patch(
        "gdk.common.parse_args_actions._list_of_command_args", return_value=["language", "template"]
    )
    ...
    mock_list_of_command_args1_conflicting = mocker.patch(
        "gdk.common.parse_args_actions._list_of_command_args", return_value=["language", "repository"]
    )
    ...
    mock_list_of_command_args2_mix_of_both = mocker.patch(
        "gdk.common.parse_args_actions._list_of_command_args", return_value=["template", "language", "repository"]
    )
...
def test_conflicting_args_with_conflict(mocker):
    ...
    mock_dic_of_conflicting_args = mocker.patch(
        "gdk.common.parse_args_actions._dic_of_conflicting_args", return_value=conflicting_arg_groups
    )

    mock_check_command_args_with_conflicting_args = mocker.patch(
        "gdk.common.parse_args_actions.check_command_args_with_conflicting_args", return_value=True
    )
    ...
    cli_model = {"init": {"conflicting_arg_groups": [["language", "template"], ["repository"], ["project"], ["interactive"]]}}
    mocker.patch.object(gdk.CLIParser.cli_tool, "cli_model", cli_model)
...
def test_conflicting_args_with_no_conflict(mocker):
    ...
    mock_check_command_args_with_conflicting_args = mocker.patch(
        "gdk.common.parse_args_actions.check_command_args_with_conflicting_args", return_value=False
    )
